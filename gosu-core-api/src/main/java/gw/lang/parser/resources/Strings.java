   ...
   static final Object[][] contents =
     {
       ...
       {Res.MSG_ASSIGNMENT_IN_IF_STATEMENT.getKey(), "Assignments are not legal inside of if conditions"},
       {Res.MSG_ASSIGNMENT_IN_LOOP_STATEMENT.getKey(), "Assignments are not legal inside of loop conditions"},
