        ...
        implements AnnotationTypeWriter
{
    ...
    protected gw.gosudoc.com.sun.javadoc.AnnotationTypeDoc annotationType;

    protected gw.gosudoc.com.sun.javadoc.Type prev;

    protected gw.gosudoc.com.sun.javadoc.Type next;
    ...
    public AnnotationTypeWriterImpl( ConfigurationImpl configuration,
                                     gw.gosudoc.com.sun.javadoc.AnnotationTypeDoc annotationType, gw.gosudoc.com.sun.javadoc.Type prevType, gw.gosudoc.com.sun.javadoc.Type nextType)
            throws Exception {
    ...
    public void addAnnotationTypeDeprecationInfo(Content annotationInfoTree) {
        ...
        gw.gosudoc.com.sun.javadoc.Tag[] deprs = annotationType.tags("deprecated");
