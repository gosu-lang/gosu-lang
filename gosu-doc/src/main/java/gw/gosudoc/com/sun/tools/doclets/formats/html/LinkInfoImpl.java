...
public class LinkInfoImpl extends LinkInfo
{
    ...
    public LinkInfoImpl(ConfigurationImpl configuration,
            Kind context, gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc executableMemberDoc) {
     ...
     */
    public LinkInfoImpl(ConfigurationImpl configuration,
            Kind context, gw.gosudoc.com.sun.javadoc.ClassDoc classDoc) {
        this.configuration = configuration;
    ...
    public final void setContext(Kind c) {
        ...
        if (type != null &&
            ...
            type.asTypeVariable().owner() instanceof gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc ) {
            excludeTypeParameterLinks = true;
        }
    }
