...
public interface Doc extends Comparable<Object> {
     ...
     *
     * @return an array of {@link gw.gosudoc.com.sun.javadoc.Tag} objects containing all tags on
     *         this Doc item.
     */
    gw.gosudoc.com.sun.javadoc.Tag[] tags();

    /**
     * Return tags of the specified {@linkplain gw.gosudoc.com.sun.javadoc.Tag#kind() kind} in
     * this Doc item.
     *
     ...
     * block tags.
     * Each section of plain text is represented as a {@link gw.gosudoc.com.sun.javadoc.Tag}
     * of {@linkplain gw.gosudoc.com.sun.javadoc.Tag#kind() kind} "Text".
     * Inline tags are represented as a {@link gw.gosudoc.com.sun.javadoc.SeeTag} of kind "@see"
     * and name "@link".
     *
     * @return an array of {@link gw.gosudoc.com.sun.javadoc.Tag}s representing the comment
     */
    gw.gosudoc.com.sun.javadoc.Tag[] inlineTags();
     ...
     * @return an array of {@link gw.gosudoc.com.sun.javadoc.Tag}s representing the
