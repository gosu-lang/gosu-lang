...
public interface Taglet {
     ...
     * @param holder a {@link gw.gosudoc.com.sun.javadoc.Doc} object holding the custom tag.
     * @param writer a {@link TagletWriter} Taglet writer.
     * @throws IllegalArgumentException thrown when the method is not supported by the taglet.
     * @return the TagletOutput representation of this <code>Tag</code>.
     */
    public abstract Content getTagletOutput( gw.gosudoc.com.sun.javadoc.Doc holder, TagletWriter writer) throws IllegalArgumentException;
