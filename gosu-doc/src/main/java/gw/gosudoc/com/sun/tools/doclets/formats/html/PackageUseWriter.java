...
import gw.gosudoc.com.sun.tools.doclets.internal.toolkit.util.ClassUseMapper;
...
public class PackageUseWriter extends SubWriterHolderWriter {
    ...
    final gw.gosudoc.com.sun.javadoc.PackageDoc pkgdoc;
    final SortedMap<String,Set<gw.gosudoc.com.sun.javadoc.ClassDoc>> usingPackageToUsedClasses = new TreeMap<>();
    ...
    public PackageUseWriter( ConfigurationImpl configuration,
                             ...
                             gw.gosudoc.com.sun.javadoc.PackageDoc pkgdoc) throws IOException {
        ...
        // used classes.
        for ( gw.gosudoc.com.sun.javadoc.ClassDoc usedClass : pkgdoc.allClasses()) {
            Set<gw.gosudoc.com.sun.javadoc.ClassDoc> usingClasses = mapper.classToClass.get(usedClass.qualifiedName());
            if (usingClasses != null) {
                for ( gw.gosudoc.com.sun.javadoc.ClassDoc usingClass : usingClasses) {
                    gw.gosudoc.com.sun.javadoc.PackageDoc usingPackage = usingClass.containingPackage();
                    Set<gw.gosudoc.com.sun.javadoc.ClassDoc> usedClasses = usingPackageToUsedClasses
    ...
    public static void generate(ConfigurationImpl configuration,
                                ClassUseMapper mapper, gw.gosudoc.com.sun.javadoc.PackageDoc pkgdoc) {
    ...
    protected void addPackageList(Content contentTree) throws IOException {
        ...
        for (int i = 0; it.hasNext(); i++) {
            gw.gosudoc.com.sun.javadoc.PackageDoc pkg = configuration.root.packageNamed(it.next());
    ...
    protected void addClassList(Content contentTree) throws IOException {
        ...
        for (String packageName : usingPackageToUsedClasses.keySet()) {
            gw.gosudoc.com.sun.javadoc.PackageDoc usingPackage = configuration.root.packageNamed(packageName);
            ...
            Content tbody = new HtmlTree(HtmlTag.TBODY);
            Iterator<gw.gosudoc.com.sun.javadoc.ClassDoc> itc =
     ...
     */
    protected void addClassRow( gw.gosudoc.com.sun.javadoc.ClassDoc usedClass, gw.gosudoc.com.sun.javadoc.PackageDoc pkg,
                                Content contentTree) {
