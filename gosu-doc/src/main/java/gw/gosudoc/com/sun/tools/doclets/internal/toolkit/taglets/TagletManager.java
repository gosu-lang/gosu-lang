...
public class TagletManager {
     ...
     */
    public void checkTags( gw.gosudoc.com.sun.javadoc.Doc doc, gw.gosudoc.com.sun.javadoc.Tag[] tags, boolean areInlineTags) {
        if (tags == null) {
            return;
        }
        Taglet taglet;
        for ( gw.gosudoc.com.sun.javadoc.Tag tag : tags) {
            ...
            if ((taglet = customTags.get(name)) != null) {
                ...
                if ((doc instanceof gw.gosudoc.com.sun.javadoc.RootDoc) && ! taglet.inOverview()) {
                    printTagMisuseWarn(taglet, tag, "overview");
                } else if ((doc instanceof gw.gosudoc.com.sun.javadoc.PackageDoc) && ! taglet.inPackage()) {
                    printTagMisuseWarn(taglet, tag, "package");
                } else if ((doc instanceof gw.gosudoc.com.sun.javadoc.ClassDoc) && ! taglet.inType()) {
                    printTagMisuseWarn(taglet, tag, "class");
                } else if ((doc instanceof gw.gosudoc.com.sun.javadoc.ConstructorDoc) && ! taglet.inConstructor()) {
                    printTagMisuseWarn(taglet, tag, "constructor");
                } else if ((doc instanceof gw.gosudoc.com.sun.javadoc.FieldDoc) && ! taglet.inField()) {
                    printTagMisuseWarn(taglet, tag, "field");
                } else if ((doc instanceof gw.gosudoc.com.sun.javadoc.MethodDoc) && ! taglet.inMethod()) {
     ...
     */
    private void printTagMisuseWarn( Taglet taglet, gw.gosudoc.com.sun.javadoc.Tag tag, String holderType) {
