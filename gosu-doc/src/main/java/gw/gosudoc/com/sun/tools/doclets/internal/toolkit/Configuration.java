...
public abstract class Configuration {
     ...
     */
    public gw.gosudoc.com.sun.javadoc.RootDoc root;
     ...
     * command-line.
     */
    public SortedSet<gw.gosudoc.com.sun.javadoc.PackageDoc> packages;
    ...
    private void initPackages() {
        ...
        for ( gw.gosudoc.com.sun.javadoc.ClassDoc aClass : root.specifiedClasses()) {
     ...
     * {@link gw.gosudoc.com.sun.javadoc.Doclet#validOptions(String[][],
     * gw.gosudoc.com.sun.javadoc.DocErrorReporter)}. This will validate the options which are shared
     ...
     */
    public String getClassName( gw.gosudoc.com.sun.javadoc.ClassDoc cd) {
     ...
     */
    public boolean isGeneratedDoc( gw.gosudoc.com.sun.javadoc.ClassDoc cd) {
        if (!nodeprecated) {
            return true;
        }
     ...
     */
    public abstract Comparator<gw.gosudoc.com.sun.javadoc.ProgramElementDoc> getMemberComparator();
    ...
    public abstract boolean showMessage( gw.gosudoc.com.sun.javadoc.SourcePosition pos, String key);
