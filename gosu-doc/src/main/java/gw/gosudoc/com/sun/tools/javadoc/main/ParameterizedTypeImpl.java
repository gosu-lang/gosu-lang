...
public class ParameterizedTypeImpl
        extends gw.gosudoc.com.sun.tools.javadoc.main.AbstractTypeImpl implements gw.gosudoc.com.sun.javadoc.ParameterizedType
{
     ...
     */
    public gw.gosudoc.com.sun.javadoc.Type[] typeArguments() {
        return gw.gosudoc.com.sun.tools.javadoc.main.TypeMaker.getTypes(env, type.getTypeArguments());
    }
     ...
     */
    public gw.gosudoc.com.sun.javadoc.Type containingType() {
        if (type.getEnclosingType().hasTag(CLASS)) {
            // This is the type of an inner class.
            return gw.gosudoc.com.sun.tools.javadoc.main.TypeMaker.getType(env, type.getEnclosingType());
        }
    ...
    public String typeName() {
        return gw.gosudoc.com.sun.tools.javadoc.main.TypeMaker.getTypeName(type, false);
    }
    ...
    static String parameterizedTypeToString( DocEnv env, ClassType cl,
                                             boolean full) {
        if (env.legacyDoclet) {
            return gw.gosudoc.com.sun.tools.javadoc.main.TypeMaker.getTypeName(cl, full);
        }
