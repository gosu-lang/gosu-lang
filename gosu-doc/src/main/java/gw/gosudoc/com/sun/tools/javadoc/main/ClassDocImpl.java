...
@Deprecated
public class ClassDocImpl extends ProgramElementDocImpl implements gw.gosudoc.com.sun.javadoc.ClassDoc
{
    ...
    private gw.gosudoc.com.sun.tools.javadoc.main.SerializedForm serializedForm;

    /**
     * Constructor
     */
    public ClassDocImpl( gw.gosudoc.com.sun.tools.javadoc.main.DocEnv env, ClassSymbol sym) {
        this(env, sym, null);
    }
    ...
    public boolean isIncluded() {
        ...
        if (env.shouldDocument(tsym)) {
            ...
            gw.gosudoc.com.sun.javadoc.ClassDoc outer = containingClass();
     ...
     */
    @Override
    public gw.gosudoc.com.sun.javadoc.PackageDoc containingPackage() {
        gw.gosudoc.com.sun.tools.javadoc.main.PackageDocImpl p = env.getPackageDoc(tsym.packge());
        if (p.setDocPath == false) {
            ...
            if (docPath == null) {
                ...
                gw.gosudoc.com.sun.javadoc.SourcePosition po = position();
                if (env.fileManager instanceof StandardJavaFileManager &&
                        po instanceof gw.gosudoc.com.sun.tools.javadoc.main.SourcePositionImpl ) {
    ...
    static String classToString( DocEnv env, ClassSymbol c, boolean full) {
        ...
        s.append( gw.gosudoc.com.sun.tools.javadoc.main.TypeMaker.typeParametersString(env, c, full));
        return s.toString();
    }
    ...
    public gw.gosudoc.com.sun.javadoc.TypeVariable[] typeParameters() {
        ...
        gw.gosudoc.com.sun.javadoc.TypeVariable res[] = new gw.gosudoc.com.sun.javadoc.TypeVariable[type.getTypeArguments().length()];
        gw.gosudoc.com.sun.tools.javadoc.main.TypeMaker.getTypes(env, type.getTypeArguments(), res);
        return res;
    }
     ...
     */
    public gw.gosudoc.com.sun.javadoc.ClassDoc superclass() {
     ...
     */
    public gw.gosudoc.com.sun.javadoc.Type superclassType() {
        if (isInterface() || isAnnotationType() ||
                (tsym == env.syms.objectType.tsym))
            return null;
        Type sup = env.types.supertype(type);
        return gw.gosudoc.com.sun.tools.javadoc.main.TypeMaker.getType(env,
     ...
     */
    public boolean subclassOf( gw.gosudoc.com.sun.javadoc.ClassDoc cd) {
     ...
     * Return an empty array if there are no interfaces.
     */
    public gw.gosudoc.com.sun.javadoc.Type[] interfaceTypes() {
        //### Cache result here?
        return gw.gosudoc.com.sun.tools.javadoc.main.TypeMaker.getTypes(env, env.types.interfaces(type));
    }
     ...
     */
    public gw.gosudoc.com.sun.javadoc.FieldDoc[] fields( boolean filter) {
     ...
     */
    public gw.gosudoc.com.sun.javadoc.FieldDoc[] fields() {
     ...
     */
    public gw.gosudoc.com.sun.javadoc.FieldDoc[] enumConstants() {
     ...
     */
    private gw.gosudoc.com.sun.javadoc.FieldDoc[] fields( boolean filter, boolean enumConstants) {
        List<gw.gosudoc.com.sun.tools.javadoc.main.FieldDocImpl> fields = List.nil();
        ...
        return fields.toArray(new gw.gosudoc.com.sun.tools.javadoc.main.FieldDocImpl[fields.length()]);
    }
     ...
     */
    public gw.gosudoc.com.sun.javadoc.MethodDoc[] methods( boolean filter) {
        Names names = tsym.name.table.names;
        List<gw.gosudoc.com.sun.tools.javadoc.main.MethodDocImpl> methods = List.nil();
        for (Symbol sym :tsym.members().getSymbols(NON_RECURSIVE)) {
            if (sym != null
                && sym.kind == MTH
                && sym.name != names.init
        ...
        //### Cache methods here?
        return methods.toArray(new gw.gosudoc.com.sun.tools.javadoc.main.MethodDocImpl[methods.length()]);
    }
     ...
     * methods in this class.  Does not include constructors.
     */
    public gw.gosudoc.com.sun.javadoc.MethodDoc[] methods() {
        return methods(true);
    }
     ...
     */
    public gw.gosudoc.com.sun.javadoc.ConstructorDoc[] constructors( boolean filter) {
        Names names = tsym.name.table.names;
     ...
     * constructors in this class.
     */
    public gw.gosudoc.com.sun.javadoc.ConstructorDoc[] constructors() {
     ...
     * are not included.
     */
    public gw.gosudoc.com.sun.javadoc.ClassDoc[] innerClasses( boolean filter) {
     ...
     * are not included.
     */
    public gw.gosudoc.com.sun.javadoc.ClassDoc[] innerClasses() {
    ...
    public gw.gosudoc.com.sun.javadoc.ClassDoc findClass( String className) {
        gw.gosudoc.com.sun.javadoc.ClassDoc searchResult = searchClass(className);
    ...
    private gw.gosudoc.com.sun.javadoc.ClassDoc searchClass( String className) {
        Names names = tsym.name.table.names;

        // search by qualified name first
        gw.gosudoc.com.sun.javadoc.ClassDoc cd = env.lookupClass(className);
        if (cd != null) {
            return cd;
        }
        ...
        for ( gw.gosudoc.com.sun.javadoc.ClassDoc icd : innerClasses()) {
            if (icd.name().equals(className) ||
                ...
                gw.gosudoc.com.sun.javadoc.ClassDoc innercd = ((ClassDocImpl) icd).searchClass(className);
                if (innercd != null) {
                    return innercd;
                }
            }
        ...
        if (tsym.sourcefile != null) {
            ...
            for (Symbol sym : s.getSymbolsByName(names.fromString(className))) {
                if (sym.kind == TYP) {
                    gw.gosudoc.com.sun.javadoc.ClassDoc c = env.getClassDoc((ClassSymbol)sym);
                    return c;
                }
            }
    ...
    private boolean hasTypeName(Type t, String name) {
        return
            name.equals( gw.gosudoc.com.sun.tools.javadoc.main.TypeMaker.getTypeName(t, true))
            ||
     ...
     */
    public gw.gosudoc.com.sun.tools.javadoc.main.MethodDocImpl findMethod( String methodName, String[] paramTypes) {
    ...
    private MethodDocImpl searchMethod( String methodName,
        ...
        // search interfaces
        for ( gw.gosudoc.com.sun.javadoc.ClassDoc intf : interfaces()) {
     ...
     */
    public gw.gosudoc.com.sun.javadoc.FieldDoc findField( String fieldName) {
        return searchField(fieldName, new HashSet<ClassDocImpl>());
    }

    private gw.gosudoc.com.sun.tools.javadoc.main.FieldDocImpl searchField( String fieldName, Set<ClassDocImpl> searched) {
        Names names = tsym.name.table.names;
        if (searched.contains(this)) {
            return null;
        }
        ...
        if (cdi != null) {
            gw.gosudoc.com.sun.tools.javadoc.main.FieldDocImpl fdi = cdi.searchField(fieldName, searched);
            if (fdi != null) {
                return fdi;
            }
        }
     ...
     */
    @Deprecated
    public gw.gosudoc.com.sun.javadoc.ClassDoc[] importedClasses() {
        // information is not available for binary classfiles
        if (tsym.sourcefile == null) return new gw.gosudoc.com.sun.javadoc.ClassDoc[0];
     ...
     */
    @Deprecated
    public gw.gosudoc.com.sun.javadoc.PackageDoc[] importedPackages() {
        // information is not available for binary classfiles
        if (tsym.sourcefile == null) return new gw.gosudoc.com.sun.javadoc.PackageDoc[0];

        ListBuffer<gw.gosudoc.com.sun.tools.javadoc.main.PackageDocImpl> importedPackages = new ListBuffer<>();
        ...
        Env<AttrContext> compenv = env.enter.getEnv(tsym);
        if (compenv == null) return new gw.gosudoc.com.sun.tools.javadoc.main.PackageDocImpl[0];
     ...
     */
    public gw.gosudoc.com.sun.javadoc.AnnotationTypeDoc asAnnotationTypeDoc() {
        return null;
    }
     ...
     */
    public gw.gosudoc.com.sun.javadoc.MethodDoc[] serializationMethods() {
        if (serializedForm == null) {
            serializedForm = new gw.gosudoc.com.sun.tools.javadoc.main.SerializedForm(env, tsym, this);
        }
        //### Clone this?
     ...
     * @see gw.gosudoc.com.sun.tools.javadoc.main.SerialFieldTagImpl
     */
    public gw.gosudoc.com.sun.javadoc.FieldDoc[] serializableFields() {
        if (serializedForm == null) {
            serializedForm = new gw.gosudoc.com.sun.tools.javadoc.main.SerializedForm(env, tsym, this);
        }
        //### Clone this?
