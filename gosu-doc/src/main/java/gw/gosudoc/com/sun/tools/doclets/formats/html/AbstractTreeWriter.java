...
public abstract class AbstractTreeWriter extends HtmlDocletWriter {
     ...
     */
    protected void addLevelInfo( gw.gosudoc.com.sun.javadoc.ClassDoc parent, Collection<gw.gosudoc.com.sun.javadoc.ClassDoc> list,
                                 boolean isEnum, Content contentTree) {
        if (!list.isEmpty()) {
            Content ul = new HtmlTree( HtmlTag.UL);
            for ( gw.gosudoc.com.sun.javadoc.ClassDoc local : list) {
     ...
     */
    protected void addTree( SortedSet<gw.gosudoc.com.sun.javadoc.ClassDoc> list, String heading, HtmlTree div) {
        if (!list.isEmpty()) {
            gw.gosudoc.com.sun.javadoc.ClassDoc firstClassDoc = list.first();
     ...
     */
    protected void addExtendsImplements( gw.gosudoc.com.sun.javadoc.ClassDoc parent, gw.gosudoc.com.sun.javadoc.ClassDoc cd,
                                         Content contentTree) {
        gw.gosudoc.com.sun.javadoc.ClassDoc[] interfaces = cd.interfaces();
