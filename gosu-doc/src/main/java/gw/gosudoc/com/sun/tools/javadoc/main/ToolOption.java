...
public enum ToolOption {
    ...
    BOOTCLASSPATH("-bootclasspath", true) {
        @Override
        public void process( ToolOption.Helper helper, String arg) {
    ...
    ADD_MODULES("--add-modules", true) {
        @Override
        public void process( ToolOption.Helper helper, String arg) throws InvalidValueException {
    ...
    PACKAGE("-package") {
        @Override
        public void process( ToolOption.Helper helper) {
            helper.setFilter(
                    Flags.PUBLIC | Flags.PROTECTED | gw.gosudoc.com.sun.tools.javadoc.main.ModifierFilter.PACKAGE);
        }
    },
    ...
    PRIVATE("-private") {
        @Override
        public void process( ToolOption.Helper helper) {
            helper.setFilter( gw.gosudoc.com.sun.tools.javadoc.main.ModifierFilter.ALL_ACCESS);
        }
    },
    ...
    void process(Helper helper, String arg) throws InvalidValueException { }
