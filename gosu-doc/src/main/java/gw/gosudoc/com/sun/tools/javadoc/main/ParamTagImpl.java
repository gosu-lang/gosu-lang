 ...
 */
@Deprecated
class ParamTagImpl extends gw.gosudoc.com.sun.tools.javadoc.main.TagImpl implements gw.gosudoc.com.sun.javadoc.ParamTag
{
     ...
     * @see gw.gosudoc.com.sun.tools.javadoc.main.ThrowsTagImpl#inlineTags()
     */
    @Override
    public Tag[] inlineTags() {
        if (inlineTags == null) {
            inlineTags = gw.gosudoc.com.sun.tools.javadoc.main.Comment.getInlineTags(holder, parameterComment);
        }
        return inlineTags;
    }
}
