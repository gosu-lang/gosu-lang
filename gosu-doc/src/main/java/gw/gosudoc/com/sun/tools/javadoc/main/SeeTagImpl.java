...
import gw.gosudoc.com.sun.javadoc.SeeTag;
 ...
 */
@Deprecated
class SeeTagImpl extends gw.gosudoc.com.sun.tools.javadoc.main.TagImpl implements SeeTag, LayoutCharacters {
    ...
    private gw.gosudoc.com.sun.javadoc.PackageDoc referencedPackage;
    private gw.gosudoc.com.sun.javadoc.ClassDoc referencedClass;
    private gw.gosudoc.com.sun.javadoc.MemberDoc referencedMember;
    ...
    SeeTagImpl( DocImpl holder, String name, String text) {
        ...
        parseSeeString();
        if (where != null) {
            gw.gosudoc.com.sun.tools.javadoc.main.ClassDocImpl container = null;
            if (holder instanceof gw.gosudoc.com.sun.javadoc.MemberDoc ) {
                container =
                  (gw.gosudoc.com.sun.tools.javadoc.main.ClassDocImpl)((gw.gosudoc.com.sun.javadoc.ProgramElementDoc)holder).containingClass();
            } else if (holder instanceof gw.gosudoc.com.sun.javadoc.ClassDoc ) {
                container = (gw.gosudoc.com.sun.tools.javadoc.main.ClassDocImpl)holder;
            }
    ...
    private void showRef() {
        ...
        if (referencedMember != null) {
            ...
            sym = ((gw.gosudoc.com.sun.tools.javadoc.main.ClassDocImpl) referencedClass).tsym;
     ...
     */
    public gw.gosudoc.com.sun.javadoc.PackageDoc referencedPackage() {
     ...
     */
    public gw.gosudoc.com.sun.javadoc.ClassDoc referencedClass() {
     ...
     */
    public gw.gosudoc.com.sun.javadoc.MemberDoc referencedMember() {
...
//                    text = text.substring(1,len-1); // strip quotes
     ...
     */
    private void findReferenced( gw.gosudoc.com.sun.tools.javadoc.main.ClassDocImpl containingClass) {
        if (where.length() > 0) {
            ...
            if (referencedClass == null && holder() instanceof gw.gosudoc.com.sun.javadoc.ProgramElementDoc ) {
                referencedClass = docenv().lookupClass(
                    ((gw.gosudoc.com.sun.javadoc.ProgramElementDoc) holder()).containingPackage().name() + "." + where);
            }
        ...
        if (what == null) {
            ...
            if (paren > 0) {
                ...
                referencedMember = findExecutableMember(memName, null,
                                                        referencedClass);
                gw.gosudoc.com.sun.javadoc.FieldDoc fd = ((gw.gosudoc.com.sun.tools.javadoc.main.ClassDocImpl)referencedClass).
                                                            findField(memName);
    ...
    private gw.gosudoc.com.sun.javadoc.MemberDoc findReferencedMethod( String memName, String[] paramarr,
                                                                       gw.gosudoc.com.sun.javadoc.ClassDoc referencedClass) {
        gw.gosudoc.com.sun.javadoc.MemberDoc meth = findExecutableMember(memName, paramarr, referencedClass);
        if (meth == null) {
            for ( gw.gosudoc.com.sun.javadoc.ClassDoc nestedClass : referencedClass.innerClasses()) {
    ...
    private gw.gosudoc.com.sun.javadoc.MemberDoc findExecutableMember( String memName, String[] paramarr,
                                                                       gw.gosudoc.com.sun.javadoc.ClassDoc referencedClass) {
