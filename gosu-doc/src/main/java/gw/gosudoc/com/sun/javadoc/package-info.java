...
The invocation is defined by the abstract {@link gw.gosudoc.com.sun.javadoc.Doclet} class
-- the entry point is the {@link gw.gosudoc.com.sun.javadoc.Doclet#start(RootDoc) start} method:
<pre>
    public static boolean <b>start</b>(RootDoc root)
</pre>
The {@link gw.gosudoc.com.sun.javadoc.RootDoc} instance holds the root of the program structure
...
{@link gw.gosudoc.com.sun.javadoc.PackageDoc#allClasses(boolean) allClasses(false)}.)
<p>

<a id="class"></a>
Throughout this API, the term <em>class</em> is normally a
shorthand for "class or interface", as in: {@link gw.gosudoc.com.sun.javadoc.ClassDoc},
{@link gw.gosudoc.com.sun.javadoc.PackageDoc#allClasses() allClasses()}, and
{@link gw.gosudoc.com.sun.javadoc.PackageDoc#findClass(String) findClass(String)}.
In only a couple of other places, it means "class, as opposed to interface",
as in:  {@link gw.gosudoc.com.sun.javadoc.Doc#isClass()}.
In the second sense, this API calls out four kinds of classes:
{@linkplain gw.gosudoc.com.sun.javadoc.Doc#isOrdinaryClass() ordinary classes},
{@linkplain gw.gosudoc.com.sun.javadoc.Doc#isEnum() enums},
{@linkplain gw.gosudoc.com.sun.javadoc.Doc#isError() errors} and
{@linkplain gw.gosudoc.com.sun.javadoc.Doc#isException() exceptions}.
...
{@link gw.gosudoc.com.sun.javadoc.Doclet Doclet} is an abstract class that specifies
the invocation interface for doclets,
{@link gw.gosudoc.com.sun.javadoc.Doclet Doclet} holds class or interface information,
{@link gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc} is a
superinterface of {@link gw.gosudoc.com.sun.javadoc.MethodDoc} and
{@link gw.gosudoc.com.sun.javadoc.ConstructorDoc},
and {@link gw.gosudoc.com.sun.javadoc.ParamTag} holds information
...
@see gw.gosudoc.com.sun.javadoc.Doclet
