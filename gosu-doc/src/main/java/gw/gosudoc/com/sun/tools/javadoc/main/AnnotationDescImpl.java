...
@Deprecated
public class AnnotationDescImpl implements gw.gosudoc.com.sun.javadoc.AnnotationDesc
{

    private final gw.gosudoc.com.sun.tools.javadoc.main.DocEnv env;
    private final Attribute.Compound annotation;


    AnnotationDescImpl( gw.gosudoc.com.sun.tools.javadoc.main.DocEnv env, Attribute.Compound annotation) {
        this.env = env;
     ...
     */
    public gw.gosudoc.com.sun.javadoc.AnnotationTypeDoc annotationType() {
    ...
    public static class ElementValuePairImpl implements ElementValuePair {
         ...
         */
        public gw.gosudoc.com.sun.javadoc.AnnotationTypeElementDoc element() {
         ...
         */
        public gw.gosudoc.com.sun.javadoc.AnnotationValue value() {
