 ...
 */
@Deprecated
public class WildcardTypeImpl extends gw.gosudoc.com.sun.tools.javadoc.main.AbstractTypeImpl implements gw.gosudoc.com.sun.javadoc.WildcardType
{
     ...
     */
    public gw.gosudoc.com.sun.javadoc.Type[] extendsBounds() {
        return gw.gosudoc.com.sun.tools.javadoc.main.TypeMaker.getTypes(env, getExtendsBounds((Type.WildcardType)type));
    }
     ...
     * Return an empty array if no such bounds are explicitly given.
     */
    public gw.gosudoc.com.sun.javadoc.Type[] superBounds() {
        return gw.gosudoc.com.sun.tools.javadoc.main.TypeMaker.getTypes(env, getSuperBounds((Type.WildcardType)type));
    }
