...
import gw.gosudoc.com.sun.tools.doclets.internal.toolkit.builders.MemberSummaryBuilder;
        ...
        implements ClassWriter
{
    ...
    protected final gw.gosudoc.com.sun.javadoc.ClassDoc prev;

    protected final gw.gosudoc.com.sun.javadoc.ClassDoc next;
     ...
     */
    public ClassWriterImpl ( ConfigurationImpl configuration, gw.gosudoc.com.sun.javadoc.ClassDoc classDoc,
    ...
    public void addClassSignature(String modifiers, Content classInfoTree) {
        ...
        if (!isInterface) {
            gw.gosudoc.com.sun.javadoc.Type superclass = utils.getFirstVisibleSuperClass(classDoc,
                    configuration);
            if (superclass != null) {
        ...
        gw.gosudoc.com.sun.javadoc.Type[] implIntfacs = classDoc.interfaceTypes();
        if (implIntfacs != null && implIntfacs.length > 0) {
            int counter = 0;
            for ( gw.gosudoc.com.sun.javadoc.Type implType : implIntfacs) {
                gw.gosudoc.com.sun.javadoc.ClassDoc classDoc = implType.asClassDoc();
     ...
     */
    private Content getClassInheritenceTree( gw.gosudoc.com.sun.javadoc.Type type) {
        gw.gosudoc.com.sun.javadoc.Type sup;
        ...
        do {
            sup = utils.getFirstVisibleSuperClass(
                    type instanceof gw.gosudoc.com.sun.javadoc.ClassDoc ? (gw.gosudoc.com.sun.javadoc.ClassDoc) type : type.asClassDoc(),
                    configuration);
            if (sup != null) {
     ...
     */
    private Content getTreeForClassHelper( gw.gosudoc.com.sun.javadoc.Type type) {
    ...
    public void addSubClassInfo(Content classInfoTree) {
        if (classDoc.isClass()) {
            ...
            SortedSet<gw.gosudoc.com.sun.javadoc.ClassDoc> subclasses = classtree.subs(classDoc, false);
    ...
    public void addSubInterfacesInfo(Content classInfoTree) {
        if (classDoc.isInterface()) {
            SortedSet<gw.gosudoc.com.sun.javadoc.ClassDoc> subInterfaces = classtree.allSubs(classDoc, false);
    ...
    public void addInterfaceUsageInfo (Content classInfoTree) {
        ...
        SortedSet<gw.gosudoc.com.sun.javadoc.ClassDoc> implcl = classtree.implementingclasses(classDoc);
        if (!implcl.isEmpty()) {
            Content label = getResource(
    ...
    public void addImplementedInterfacesInfo(Content classInfoTree) {
        ...
        List<gw.gosudoc.com.sun.javadoc.Type> interfaceArray = utils.getAllInterfaces(classDoc, configuration);
    ...
    public void addNestedClassInfo(Content classInfoTree) {
        gw.gosudoc.com.sun.javadoc.ClassDoc outerClass = classDoc.containingClass();
        if (outerClass != null) {
            Content label;
    ...
    public boolean isFunctionalInterface() {
        if (configuration.root instanceof RootDocImpl) {
            ...
            gw.gosudoc.com.sun.javadoc.AnnotationDesc[] annotationDescList = classDoc.annotations();
            for ( gw.gosudoc.com.sun.javadoc.AnnotationDesc annoDesc : annotationDescList) {
    ...
    public void addClassDeprecationInfo(Content classInfoTree) {
        ...
        gw.gosudoc.com.sun.javadoc.Tag[] deprs = classDoc.tags("deprecated");
    ...
    private Content getClassLinks(LinkInfoImpl.Kind context, Collection<?> list) {
        ...
        for (Object item : typeList) {
            ...
            if (item instanceof gw.gosudoc.com.sun.javadoc.ClassDoc ) {
                Content link = getLink(new LinkInfoImpl(configuration, context, (gw.gosudoc.com.sun.javadoc.ClassDoc)item));
                dd.addContent(link);
            } else {
                Content link = getLink(new LinkInfoImpl(configuration, context, (gw.gosudoc.com.sun.javadoc.Type)item));
                dd.addContent(link);
            }
        }
        return dd;
     ...
     * @return the classDoc being documented.
     */
    public gw.gosudoc.com.sun.javadoc.ClassDoc getClassDoc() {
        return classDoc;
    }
}
