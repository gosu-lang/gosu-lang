...
import gw.gosudoc.com.sun.tools.doclets.internal.toolkit.taglets.DeprecatedTaglet;
...
public abstract class AbstractMemberWriter {
    ...
    protected final gw.gosudoc.com.sun.javadoc.ClassDoc classdoc;
    ...
    public AbstractMemberWriter(SubWriterHolderWriter writer, gw.gosudoc.com.sun.javadoc.ClassDoc classdoc) {
     ...
     */
    public abstract String[] getSummaryTableHeader( gw.gosudoc.com.sun.javadoc.ProgramElementDoc member);
     ...
     */
    public abstract void addInheritedSummaryLabel( gw.gosudoc.com.sun.javadoc.ClassDoc cd, Content inheritedTree);
     ...
     */
    public abstract void addSummaryAnchor( gw.gosudoc.com.sun.javadoc.ClassDoc cd, Content memberTree);
     ...
     */
    public abstract void addInheritedSummaryAnchor( gw.gosudoc.com.sun.javadoc.ClassDoc cd, Content inheritedTree);
     ...
     */
    protected abstract void addSummaryType( gw.gosudoc.com.sun.javadoc.ProgramElementDoc member,
     ...
     */
    protected void addSummaryLink( gw.gosudoc.com.sun.javadoc.ClassDoc cd, gw.gosudoc.com.sun.javadoc.ProgramElementDoc member,
                                   Content tdSummary) {
    ...
    protected abstract void addSummaryLink( LinkInfoImpl.Kind context,
                                            gw.gosudoc.com.sun.javadoc.ClassDoc cd, gw.gosudoc.com.sun.javadoc.ProgramElementDoc member, Content tdSummary);
     ...
     */
    protected abstract void addInheritedSummaryLink( gw.gosudoc.com.sun.javadoc.ClassDoc cd,
     ...
     */
    protected abstract Content getDeprecatedLink( gw.gosudoc.com.sun.javadoc.ProgramElementDoc member);
     ...
     */
    protected abstract Content getNavSummaryLink( gw.gosudoc.com.sun.javadoc.ClassDoc cd, boolean link);
     ...
     */
    protected String modifierString( gw.gosudoc.com.sun.javadoc.MemberDoc member) {
        int ms = member.modifierSpecifier();
        int no = Modifier.NATIVE | Modifier.SYNCHRONIZED;
    return Modifier.toString(ms & ~no);
    }

    protected String typeString( gw.gosudoc.com.sun.javadoc.MemberDoc member) {
        String type = "";
        if (member instanceof gw.gosudoc.com.sun.javadoc.MethodDoc ) {
            type = ((gw.gosudoc.com.sun.javadoc.MethodDoc)member).returnType().toString();
        } else if (member instanceof gw.gosudoc.com.sun.javadoc.FieldDoc ) {
            type = ((gw.gosudoc.com.sun.javadoc.FieldDoc)member).type().toString();
        }
        return type;
    }
     ...
     */
    protected void addModifiers( gw.gosudoc.com.sun.javadoc.MemberDoc member, Content htmltree) {
        ...
        if ((member.isField() || member.isMethod()) &&
            ...
            mod = (member.isMethod() && ((gw.gosudoc.com.sun.javadoc.MethodDoc)member).isDefault()) ?
     ...
     */
    protected void addModifierAndType( gw.gosudoc.com.sun.javadoc.ProgramElementDoc member, gw.gosudoc.com.sun.javadoc.Type type,
                                       Content tdSummaryType) {
        ...
        if (type == null) {
            ...
            if (member instanceof gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc &&
                    ((gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc) member).typeParameters().length > 0) {
                Content typeParameters = ((AbstractExecutableMemberWriter) this).getTypeParameters(
                        (gw.gosudoc.com.sun.javadoc.ExecutableMemberDoc) member);
     ...
     */
    private void addModifier( gw.gosudoc.com.sun.javadoc.ProgramElementDoc member, Content code) {
        ...
        if (member.isMethod()) {
            if (!(member.containingClass().isInterface()) &&
                    ((gw.gosudoc.com.sun.javadoc.MethodDoc)member).isAbstract()) {
            ...
            if (((gw.gosudoc.com.sun.javadoc.MethodDoc)member).isDefault()) {
     ...
     */
    protected void addDeprecatedInfo( gw.gosudoc.com.sun.javadoc.ProgramElementDoc member, Content contentTree) {
     ...
     */
    protected void addComment( gw.gosudoc.com.sun.javadoc.ProgramElementDoc member, Content htmltree) {
        if (member.inlineTags().length > 0) {
            writer.addInlineComment(member, htmltree);
        }
    }

    protected String name( gw.gosudoc.com.sun.javadoc.ProgramElementDoc member) {
        return member.name();
    }
     ...
     */
    protected Content getHead( gw.gosudoc.com.sun.javadoc.MemberDoc member) {
    ...
    * false otherwise.
    */
    protected boolean isInherited( gw.gosudoc.com.sun.javadoc.ProgramElementDoc ped){
     ...
     */
    protected void addDeprecatedAPI( List<gw.gosudoc.com.sun.javadoc.Doc> deprmembers, String headingKey,
        ...
        if (deprmembers.size() > 0) {
            ...
            for (int i = 0; i < deprmembers.size(); i++) {
                gw.gosudoc.com.sun.javadoc.ProgramElementDoc member =(gw.gosudoc.com.sun.javadoc.ProgramElementDoc)deprmembers.get(i);
     ...
     */
    protected void addUseInfo(List<? extends gw.gosudoc.com.sun.javadoc.ProgramElementDoc> mems,
            Content heading, String tableSummary, Content contentTree) {
        if (mems == null) {
            return;
        }
        List<? extends gw.gosudoc.com.sun.javadoc.ProgramElementDoc> members = mems;
        ...
        if (members.size() > 0) {
            ...
            Content tbody = new HtmlTree(HtmlTag.TBODY);
            Iterator<? extends gw.gosudoc.com.sun.javadoc.ProgramElementDoc> it = members.iterator();
            for (int i = 0; it.hasNext(); i++) {
                gw.gosudoc.com.sun.javadoc.ProgramElementDoc pgmdoc = it.next();
                gw.gosudoc.com.sun.javadoc.ClassDoc cd = pgmdoc.containingClass();
                ...
                if (cd != null && !(pgmdoc instanceof ConstructorDoc)
                        && !(pgmdoc instanceof gw.gosudoc.com.sun.javadoc.ClassDoc)) {
                    HtmlTree name = new HtmlTree(HtmlTag.SPAN);
                    name.addStyle(HtmlStyle.typeNameLabel);
                    name.addContent(cd.name() + ".");
                    tdLast.addContent(name);
                }
                addSummaryLink(pgmdoc instanceof gw.gosudoc.com.sun.javadoc.ClassDoc ?
    ...
    protected void addNavSummaryLink( List<?> members,
        ...
        gw.gosudoc.com.sun.javadoc.ClassDoc icd = classdoc.superclass();
        while (icd != null) {
    ...
    protected void serialWarning( gw.gosudoc.com.sun.javadoc.SourcePosition pos, String key, String a1, String a2) {
        if (configuration.serialwarn) {
            configuration.getDocletSpecificMsg().warning(pos, key, a1, a2);
        }
    }

    public gw.gosudoc.com.sun.javadoc.ProgramElementDoc[] eligibleMembers( gw.gosudoc.com.sun.javadoc.ProgramElementDoc[] members) {
    ...
    public void addMemberSummary( gw.gosudoc.com.sun.javadoc.ClassDoc classDoc, gw.gosudoc.com.sun.javadoc.ProgramElementDoc member,
                                  gw.gosudoc.com.sun.javadoc.Tag[] firstSentenceTags, List<Content> tableContents, int counter) {
        ...
        if (member instanceof gw.gosudoc.com.sun.javadoc.MethodDoc && !member.isAnnotationTypeElement()) {
            int methodType = (member.isStatic()) ? MethodTypes.STATIC.value() :
                    MethodTypes.INSTANCE.value();
            if (member.containingClass().isInterface()) {
                methodType = (((gw.gosudoc.com.sun.javadoc.MethodDoc) member).isAbstract())
    ...
    public void addInheritedMemberSummary( gw.gosudoc.com.sun.javadoc.ClassDoc classDoc,
                                           gw.gosudoc.com.sun.javadoc.ProgramElementDoc nestedClass, boolean isFirst, boolean isLast,
                                           Content linksTree) {
     ...
     */
    public Content getSummaryTableTree( gw.gosudoc.com.sun.javadoc.ClassDoc classDoc, List<Content> tableContents) {
