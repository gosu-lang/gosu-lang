...
public class DocEnv {
    ...
    gw.gosudoc.com.sun.tools.javadoc.main.DocLocale doclocale;
    ...
    Context context;
    DocLint doclint;
    gw.gosudoc.com.sun.tools.javadoc.main.JavaScriptScanner javaScriptScanner;
    ...
    protected DocEnv(Context context) {
        ...
        this.doclocale = new gw.gosudoc.com.sun.tools.javadoc.main.DocLocale(this, "", breakiterator);
     ...
     */
    public gw.gosudoc.com.sun.tools.javadoc.main.ClassDocImpl lookupClass( String name) {
     ...
     */
    public gw.gosudoc.com.sun.tools.javadoc.main.ClassDocImpl loadClass( String name) {
        try {
     ...
     */
    public gw.gosudoc.com.sun.tools.javadoc.main.PackageDocImpl lookupPackage( String name) {
    ...
    public void setLocale(String localeName) {
        ...
        doclocale = new gw.gosudoc.com.sun.tools.javadoc.main.DocLocale(this, localeName, breakiterator);
     ...
     */
    public void error( gw.gosudoc.com.sun.tools.javadoc.main.DocImpl doc, String key) {
        if (silent)
            return;
     ...
     * @param key selects message from resource
     */
    public void error( gw.gosudoc.com.sun.javadoc.SourcePosition pos, String key) {
        if (silent)
            return;
     ...
     */
    public void error( gw.gosudoc.com.sun.tools.javadoc.main.DocImpl doc, String key, String a1) {
        if (silent)
            return;
     ...
     */
    public void error( gw.gosudoc.com.sun.tools.javadoc.main.DocImpl doc, String key, String a1, String a2) {
        if (silent)
            return;
     ...
     */
    public void error( gw.gosudoc.com.sun.tools.javadoc.main.DocImpl doc, String key, String a1, String a2, String a3) {
        if (silent)
            return;
     ...
     * @param key selects message from resource
     */
    public void warning( gw.gosudoc.com.sun.tools.javadoc.main.DocImpl doc, String key) {
        if (silent)
            return;
     ...
     * @param a1 first argument
     */
    public void warning( gw.gosudoc.com.sun.tools.javadoc.main.DocImpl doc, String key, String a1) {
        if (silent)
            return;
     ...
     * @param a2 second argument
     */
    public void warning( gw.gosudoc.com.sun.tools.javadoc.main.DocImpl doc, String key, String a1, String a2) {
        if (silent)
            return;
    ...
    protected Map<PackageSymbol, gw.gosudoc.com.sun.tools.javadoc.main.PackageDocImpl> packageMap = new HashMap<>();
    /**
     * Return the PackageDoc of this package symbol.
     */
    public gw.gosudoc.com.sun.tools.javadoc.main.PackageDocImpl getPackageDoc( PackageSymbol pack) {
        gw.gosudoc.com.sun.tools.javadoc.main.PackageDocImpl result = packageMap.get(pack);
        if (result != null) return result;
        result = new gw.gosudoc.com.sun.tools.javadoc.main.PackageDocImpl(this, pack);
    ...
    protected Map<ClassSymbol, gw.gosudoc.com.sun.tools.javadoc.main.ClassDocImpl> classMap = new HashMap<>();
    /**
     * Return the ClassDoc (or a subtype) of this class symbol.
     */
    public gw.gosudoc.com.sun.tools.javadoc.main.ClassDocImpl getClassDoc( ClassSymbol clazz) {
        gw.gosudoc.com.sun.tools.javadoc.main.ClassDocImpl result = classMap.get(clazz);
        if (result != null) return result;
        if (isAnnotationType(clazz)) {
            result = new AnnotationTypeDocImpl(this, clazz);
        } else {
            result = new gw.gosudoc.com.sun.tools.javadoc.main.ClassDocImpl(this, clazz);
        }
    ...
    protected Map<VarSymbol, gw.gosudoc.com.sun.tools.javadoc.main.FieldDocImpl> fieldMap = new HashMap<>();
    /**
     * Return the FieldDoc of this var symbol.
     */
    public gw.gosudoc.com.sun.tools.javadoc.main.FieldDocImpl getFieldDoc( VarSymbol var) {
        gw.gosudoc.com.sun.tools.javadoc.main.FieldDocImpl result = fieldMap.get(var);
        if (result != null) return result;
        result = new gw.gosudoc.com.sun.tools.javadoc.main.FieldDocImpl(this, var);
    ...
    protected void makeMethodDoc(MethodSymbol meth, TreePath treePath) {
        gw.gosudoc.com.sun.tools.javadoc.main.MethodDocImpl result = (gw.gosudoc.com.sun.tools.javadoc.main.MethodDocImpl)methodMap.get(meth);
        if (result != null) {
            if (treePath != null) result.setTreePath(treePath);
        } else {
            result = new gw.gosudoc.com.sun.tools.javadoc.main.MethodDocImpl(this, meth, treePath);
     ...
     * Should be called only on symbols representing methods.
     */
    public gw.gosudoc.com.sun.tools.javadoc.main.MethodDocImpl getMethodDoc( MethodSymbol meth) {
        assert !meth.isConstructor() : "not expecting a constructor symbol";
        gw.gosudoc.com.sun.tools.javadoc.main.MethodDocImpl result = (MethodDocImpl)methodMap.get(meth);
        if (result != null) return result;
    ...
    protected void makeConstructorDoc(MethodSymbol meth, TreePath treePath) {
        gw.gosudoc.com.sun.tools.javadoc.main.ConstructorDocImpl result = (gw.gosudoc.com.sun.tools.javadoc.main.ConstructorDocImpl)methodMap.get(meth);
        if (result != null) {
            if (treePath != null) result.setTreePath(treePath);
        } else {
            result = new gw.gosudoc.com.sun.tools.javadoc.main.ConstructorDocImpl(this, meth, treePath);
            methodMap.put(meth, result);
        }
    }
     ...
     * Should be called only on symbols representing constructors.
     */
    public gw.gosudoc.com.sun.tools.javadoc.main.ConstructorDocImpl getConstructorDoc( MethodSymbol meth) {
        assert meth.isConstructor() : "expecting a constructor symbol";
        gw.gosudoc.com.sun.tools.javadoc.main.ConstructorDocImpl result = (ConstructorDocImpl)methodMap.get(meth);
        if (result != null) return result;
    ...
    protected void makeAnnotationTypeElementDoc(MethodSymbol meth, TreePath treePath) {
        gw.gosudoc.com.sun.tools.javadoc.main.AnnotationTypeElementDocImpl result =
            (gw.gosudoc.com.sun.tools.javadoc.main.AnnotationTypeElementDocImpl)methodMap.get(meth);
        if (result != null) {
            if (treePath != null) result.setTreePath(treePath);
        } else {
            result =
                new gw.gosudoc.com.sun.tools.javadoc.main.AnnotationTypeElementDocImpl(this, meth, treePath);
            methodMap.put(meth, result);
        }
    }
     ...
     * Should be called only on symbols representing annotation type elements.
     */
    public gw.gosudoc.com.sun.tools.javadoc.main.AnnotationTypeElementDocImpl getAnnotationTypeElementDoc(
            MethodSymbol meth) {
