...
public class PackageIndexWriter extends AbstractPackageIndexWriter {
     ...
     */
    private gw.gosudoc.com.sun.javadoc.RootDoc root;
     ...
     * @see Group
     */
    private Map<String,List<gw.gosudoc.com.sun.javadoc.PackageDoc>> groupPackageMap;
    ...
    protected void addIndex( Content body) {
        for (String groupname : groupList) {
            List<gw.gosudoc.com.sun.javadoc.PackageDoc> list = groupPackageMap.get(groupname);
     ...
     */
    protected void addPackagesList( Collection<gw.gosudoc.com.sun.javadoc.PackageDoc> packages, Content tbody) {
