...
public class PackageTreeWriter extends AbstractTreeWriter {
    ...
    public PackageTreeWriter( ConfigurationImpl configuration,
                              DocPath path,
                              gw.gosudoc.com.sun.javadoc.PackageDoc packagedoc,
                              gw.gosudoc.com.sun.javadoc.PackageDoc prev, gw.gosudoc.com.sun.javadoc.PackageDoc next)
                      throws IOException {
    ...
    public static void generate( ConfigurationImpl configuration,
                                 gw.gosudoc.com.sun.javadoc.PackageDoc pkg, gw.gosudoc.com.sun.javadoc.PackageDoc prev,
