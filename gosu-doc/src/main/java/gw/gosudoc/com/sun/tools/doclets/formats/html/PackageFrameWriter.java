...
public class PackageFrameWriter extends HtmlDocletWriter {
     ...
     */
    private gw.gosudoc.com.sun.javadoc.PackageDoc packageDoc;

    /**
     * The classes to be documented.  Use this to filter out classes
     * that will not be documented.
     */
    private Set<gw.gosudoc.com.sun.javadoc.ClassDoc> documentedClasses;
     ...
     */
    protected void addClassKindListing( gw.gosudoc.com.sun.javadoc.ClassDoc[] arr, Content labelContent,
        ...
        if(arr.length > 0) {
            ...
            for ( gw.gosudoc.com.sun.javadoc.ClassDoc classDoc : arr) {
