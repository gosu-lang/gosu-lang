...
public class DeprecatedAPIListBuilder {
     ...
     */
    private List<List<gw.gosudoc.com.sun.javadoc.Doc>> deprecatedLists;
    ...
    public DeprecatedAPIListBuilder(Configuration configuration) {
        ...
        for (int i = 0; i < NUM_TYPES; i++) {
            deprecatedLists.add(i, new ArrayList<gw.gosudoc.com.sun.javadoc.Doc>());
        }
    ...
    private void buildDeprecatedAPIInfo() {
        ...
        for ( gw.gosudoc.com.sun.javadoc.ClassDoc cd : configuration.root.classes()) {
     ...
     */
    private void composeDeprecatedList( List<gw.gosudoc.com.sun.javadoc.Doc> list, gw.gosudoc.com.sun.javadoc.MemberDoc[] members) {
        for ( gw.gosudoc.com.sun.javadoc.MemberDoc member : members) {
     ...
     */
    public List<gw.gosudoc.com.sun.javadoc.Doc> getList( int type) {
