...
public class Group {
     ...
     */
    public Map<String, List<gw.gosudoc.com.sun.javadoc.PackageDoc>> groupPackages( Set<gw.gosudoc.com.sun.javadoc.PackageDoc> packages) {
        Map<String,List<gw.gosudoc.com.sun.javadoc.PackageDoc>> groupPackageMap = new HashMap<>();
     ...
     */
    List<gw.gosudoc.com.sun.javadoc.PackageDoc> getPkgList( Map<String,List<gw.gosudoc.com.sun.javadoc.PackageDoc>> map, String groupname) {
