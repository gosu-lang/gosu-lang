...
class SerialFieldTagImpl
    extends gw.gosudoc.com.sun.tools.javadoc.main.TagImpl
    implements SerialFieldTag, Comparable<Object>
{
    ...
    private gw.gosudoc.com.sun.javadoc.ClassDoc containingClass;   // Class containing serialPersistentField member
    private gw.gosudoc.com.sun.javadoc.ClassDoc fieldTypeDoc;      // ClassDocImpl of fieldType
    private gw.gosudoc.com.sun.tools.javadoc.main.FieldDocImpl matchingField; // FieldDocImpl with same name as fieldName
   ...
   SerialFieldTagImpl( DocImpl holder, String name, String text) {
     ...
     */
    public gw.gosudoc.com.sun.javadoc.ClassDoc fieldTypeDoc() {
    ...
    public String description() {
        if (description.length() == 0 && matchingField != null) {
            ...
            gw.gosudoc.com.sun.tools.javadoc.main.Comment comment = matchingField.comment();
            if (comment != null) {
