...
public class XmlSchemaAttributeGroupIndexer extends XmlSchemaIndexer<XmlSchemaAttributeGroup> {

  @Override
  public <T> void index( XmlSchemaAttributeGroup group, String prefix, List<XmlSchemaFlattenedChild> flattenedChildren, boolean topLevel, boolean isPlural, XmlSchemaType currentType, boolean createTypes, Map<QName, XmlSchemaElementTypeData> usedElementNames, Map<Pair<XmlSchemaPropertyType, QName>, Boolean> pluralityMap, T context, List<Runnable> todo ) {
    for ( XmlSchemaAttributeOrAttributeGroup attribute : group.getAttributes() ) {
      XmlSchemaIndexer.invokeIndexer( attribute, prefix, flattenedChildren, false, isPlural, currentType, createTypes, usedElementNames, pluralityMap, context, todo );
    }
    if ( group.getAnyAttribute() != null) {
      XmlSchemaIndexer.invokeIndexer( group.getAnyAttribute(), prefix, flattenedChildren, false, isPlural, currentType, createTypes, usedElementNames, pluralityMap, context, todo );
    }
