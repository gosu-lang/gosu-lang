...
class Errant_ExpansionExpressionsTest {
 function testbasicExpansionNonStaticMethod() {
  ...
  function testNoImplicitExpansion() {
    var arr: String[]
    var expArr = arr.toUpperCase()  //## issuekeys: MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD

    var l: List<String>
    var expL = l.toUpperCase()      //## issuekeys: MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD
  }
}