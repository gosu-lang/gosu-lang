...
class Errant_DefaultMethodsTest extends FooBase implements IFoo, IFu {
  override function fred(): String {
    ...
    super.fred()  //## issuekeys: MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD, MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD, MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD
    super.abstFromBase()  //## issuekeys: MSG_ABSTRACT_METHOD_CANNOT_BE_ACCESSED_DIRECTLY
    super.fromBase()

    super[FooBase].fred()  //## issuekeys: MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD, MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD, MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD
  ...
  override function noDefault() {
    super.noDefault()  //## issuekeys: MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD, MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD, MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD
    super[IFoo].noDefault()  //## issuekeys: MSG_ABSTRACT_METHOD_CANNOT_BE_ACCESSED_DIRECTLY
  }
