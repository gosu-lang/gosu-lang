...
class Errant_StaticInterfaceMethodsTest implements IMyInterface {
  static function myOwnFunc() {
    ...
    MyClass.myStaticFunc()  //## issuekeys: MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD, MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD, MSG_NO_METHOD_DESCRIPTOR_FOUND_FOR_METHOD
  }
}
