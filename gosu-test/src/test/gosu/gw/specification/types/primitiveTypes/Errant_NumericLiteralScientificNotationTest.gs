...
class Errant_NumericLiteralScientificNotationTest {
  ...
  function scientificNotationWithWrongSuffix() : void {
    var a : float = 1fe+2f   //## issuekeys: MSG_SYNTAX_ERROR, MSG_UNEXPECTED_TOKEN, MSG_NOT_A_STATEMENT, MSG_BAD_IDENTIFIER_NAME, MSG_UNEXPECTED_TOKEN, MSG_UNEXPECTED_TOKEN
    var b : float = 1.0fe+2f  //## issuekeys: MSG_SYNTAX_ERROR, MSG_UNEXPECTED_TOKEN, MSG_UNEXPECTED_TOKEN, MSG_UNEXPECTED_TOKEN, MSG_NOT_A_STATEMENT, MSG_BAD_IDENTIFIER_NAME, MSG_UNEXPECTED_TOKEN, MSG_UNEXPECTED_TOKEN
    var c : float = 1.fe+2f  //## issuekeys: MSG_NOT_A_STATEMENT, MSG_BAD_IDENTIFIER_NAME, MSG_UNEXPECTED_TOKEN, MSG_UNEXPECTED_TOKEN
    var d : double = 1fe+2d  //## issuekeys: MSG_SYNTAX_ERROR, MSG_UNEXPECTED_TOKEN, MSG_NOT_A_STATEMENT, MSG_BAD_IDENTIFIER_NAME, MSG_UNEXPECTED_TOKEN, MSG_UNEXPECTED_TOKEN
  }
