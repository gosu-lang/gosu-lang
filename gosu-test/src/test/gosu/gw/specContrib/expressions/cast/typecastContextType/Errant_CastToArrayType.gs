...
class Errant_CastToArrayType {
  function foo() {
    var ao: Object[] = {1, 2, 3} as Integer[]

    var labels1: Object[] = {"1", "2", "3"} as String[]
    var labels2: String[] = {"1", "2", "3"} as String[]
