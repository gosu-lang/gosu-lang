...
class Errant_BlocksCollections {
  ...
  function testCollectionsBlocks() {
    ...
    var block6112: block(): ArrayList = \-> {
      1,2,3      //## issuekeys: NOT A STATEMENT
    }
    var block6113: block(): ArrayList<Object> = \-> {
      return {1, 2, 3}
    }
    var block6114: block(): ArrayList<String> = \-> {      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'BLOCK():ARRAYLIST<INTEGER>', REQUIRED: 'BLOCK():ARRAYLIST<STRING>'
      return {1, 2, 3}
    }
    ...
    var block6120: block(): HashMap = \-> {
      return {1, 2, 3}      //## issuekeys: EXPECTED '->' AFTER MAP KEY
    }
    ...
    var block6125: block(): HashMap<Integer, String> = \-> {
      return {1->2, 3->4.5}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'INT', REQUIRED: 'JAVA.LANG.STRING'
    }
