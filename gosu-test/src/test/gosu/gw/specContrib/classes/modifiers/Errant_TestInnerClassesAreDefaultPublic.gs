...
class Errant_TestInnerClassesAreDefaultPublic {
  function test() {
    ...
    var inner5 : Errant_OtherTestClass.InnerPrivateClass       //## issuekeys: MSG_TYPE_HAS_XXX_ACCESS
    var inner6 : Errant_OtherTestClass.InnerPrivateInterface   //## issuekeys: MSG_TYPE_HAS_XXX_ACCESS
    var inner7 : Errant_OtherTestClass.InnerPrivateStructure   //## issuekeys: MSG_TYPE_HAS_XXX_ACCESS
    var inner8 : Errant_OtherTestClass.InnerPrivateEnum        //## issuekeys: MSG_TYPE_HAS_XXX_ACCESS
  }
}