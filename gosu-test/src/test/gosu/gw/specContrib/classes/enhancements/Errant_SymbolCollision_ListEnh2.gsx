...
enhancement Errant_SymbolCollision_ListEnh2<B>: List<B> {
  ...
  internal function internalFunction(b: B) {}      //## issuekeys: THE FUNCTION 'INTERNALFUNCTION(B)' IS ALREADY DEFINED IN THE TYPE 'GW.SPECCONTRIB.CLASSES.ENHANCEMENTS.A.ERRANT_ENHANCEMENTSYMBOLNAMECOLLISION1'. ENHANCEMENTS CANNOT OVERRIDE FUNCTIONS.
  ...
  internal property set InternalProperty(b: B) {}      //## issuekeys: THE FUNCTION 'SETINTERNALPROPERTY(B)' IS ALREADY DEFINED IN THE TYPE 'GW.SPECCONTRIB.CLASSES.ENHANCEMENTS.A.ERRANT_ENHANCEMENTSYMBOLNAMECOLLISION1'. ENHANCEMENTS CANNOT OVERRIDE FUNCTIONS.
