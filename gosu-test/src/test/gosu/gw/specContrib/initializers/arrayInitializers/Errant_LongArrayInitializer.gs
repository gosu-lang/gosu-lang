...
class Errant_LongArrayInitializer {
  ...
  var longArray113 : long[] = {1 as short,2 as short,3 as short}
  ...
  var longArray121 : long[] = {100L, 1b, 1 as short}
  ...
  var longArray129 : long[] = {'c', 1b, 1 as short, 42, 42.5f, 42L, 42.5}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.LANG.DOUBLE>', REQUIRED: 'LONG[]'

  var longArray211 : Long[] = {'c', 'd', 'e'}
  var longArray212 : Long[] = {1b, 2b, 3b}
  var longArray213 : Long[] = {1 as short,2 as short,3 as short}
  ...
  var longArray221 : Long[] = {100L, 1b, 1 as short}
  ...
  var longArray229 : Long[] = {'c', 1b, 1 as short, 42, 42.5f, 42L, 42.5}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.LANG.DOUBLE>', REQUIRED: 'JAVA.LANG.LONG[]'
}