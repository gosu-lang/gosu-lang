...
class Errant_DoubleArrayInitializer {
  ...
  var doubleArray113 : double[] = {1 as short,2 as short,3 as short}
  ...
  var doubleArray121 : double[] = {100.5, 1b, 1 as short}
  ...
  var doubleArray129 : double[] = {'c', 1b, 1 as short, 42, 42.5f, 42L, 42.5}

  var doubleArray211 : Double[] = {'c', 'd', 'e'}
  var doubleArray212 : Double[] = {1b, 2b, 3b}
  var doubleArray213 : Double[] = {1 as short,2 as short,3 as short}
  ...
  var doubleArray221 : Double[] = {100.5, 1b, 1 as short}
  ...
  var doubleArray229 : Double[] = {'c', 1b, 1 as short, 42, 42.5f, 42L, 42.5}
}