...
class Errant_IntegerArrayInitializer {
  ...
  var intArray113 : int[] = {1 as short,2 as short,3 as short}
  ...
  var intArray121 : int[] = {12, 1b, 1 as short}
  ...
  var intArray128 : int[] = {'c', 1b, 1 as short, 42, 42.5f, 42L, 42.5}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.LANG.DOUBLE>', REQUIRED: 'INT[]'

  var intArray211 : Integer[] = {'c', 'd','e'}
  var intArray212 : Integer[] = {1b, 2b, 3b}
  var intArray213 : Integer[] = {1 as short,2 as short,3 as short}
  ...
  var intArray221 : Integer[] = {12, 1b, 1 as short}
  ...
  var intArray228 : Integer[] = {'c', 1b, 1 as short, 42, 42.5f, 42L, 42.5}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.LANG.DOUBLE>', REQUIRED: 'INT[]'
