...
class Errant_ShortArrayInitializer {
  ...
  var shortArray113 : short[] = {1 as short,2 as short,3 as short}
  //IDE-1284
  ...
  var shortArray120 : short[] = {1 as short, 'c'}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>', REQUIRED: 'SHORT[]'
  //IDE-1284
  var shortArray121 : short[] = {1 as short, 1b}
  //IDE-1284
  var shortArray122 : short[] = {1 as short, 42}
  var shortArray123 : short[] = {1 as short, 45l}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.LANG.LONG>', REQUIRED: 'SHORT[]'
  ...
  var shortArray125 : short[] = {1 as short, "mystring"}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<? EXTENDS JAVA.LANG.COMPARABLE<?>>>>', REQUIRED: 'SHORT[]'
  ...
  var shortArray127 : short[] = {1 as short, new Date()}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<? EXTENDS JAVA.LANG.COMPARABLE<?>>>>', REQUIRED: 'SHORT[]'
  var shortArray128 : short[] = {'c', 1b, 1 as short, 42, 42.5f, 42L, 42.5}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.LANG.DOUBLE>', REQUIRED: 'SHORT[]'
  ...
  var shortArray213 : Short[] = {1 as short,2 as short,3 as short}
  //IDE-1284
  ...
  var shortArray220 : Short[] = {1 as short, 'c'}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>', REQUIRED: 'SHORT[]'
  //IDE-1284
  var shortArray221 : Short[] = {1 as short, 1b}
  //IDE-1284
  var shortArray222 : Short[] = {1 as short, 42}
  var shortArray223 : Short[] = {1 as short, 45l}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.LANG.LONG>', REQUIRED: 'SHORT[]'
  ...
  var shortArray225 : Short[] = {1 as short, "mystring"}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<? EXTENDS JAVA.LANG.COMPARABLE<?>>>>', REQUIRED: 'SHORT[]'
  ...
  var shortArray227 : Short[] = {1 as short, new Date()}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<? EXTENDS JAVA.LANG.COMPARABLE<?>>>>', REQUIRED: 'SHORT[]'
  var shortArray228 : Short[] = {'c', 1b, 1 as short, 42, 42.5f, 42L, 42.5}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.LANG.DOUBLE>', REQUIRED: 'SHORT[]'
