...
class Errant_BigIntegerArrayInitializer {
  ...
  var bigIntegerArray113 : BigInteger[] = {1 as short,2 as short,3 as short}
  ...
  var bigIntegerArray121 : BigInteger[] = {BigInteger.ONE, 1b, 1 as short}
  ...
  var bigIntegerArray129 : BigInteger[] = {'c', 1b, 1 as short, 42, 42.5f, 42L, 42.5}      //## issuekeys: INCOMPATIBLE TYPES. FOUND: 'JAVA.UTIL.ARRAYLIST<JAVA.LANG.DOUBLE>', REQUIRED: 'JAVA.MATH.BIGINTEGER[]'
