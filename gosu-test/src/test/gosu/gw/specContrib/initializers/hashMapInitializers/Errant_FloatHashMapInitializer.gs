...
class Errant_FloatHashMapInitializer {
  ...
  var floatHashMap1112 : HashMap<Float, Float> = {42.5f->1 as short}
  ...
  var floatHashMap1212 : HashMap<Float, Float> = {1 as short-> 42.5f}
  ...
  var floatHashMap1312 : HashMap<Float, Float> = {42.5f->43.5f, 42.5f->1 as short}
  ...
  var floatHashMap1412 : HashMap<Float, Float> = {42.5f->43.5f, 1 as short->43.5f}
