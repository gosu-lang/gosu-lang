...
class Errant_OperatorCombinations {
  function f() {
    ...
    var eq3 = 42 == !2              //## issuekeys: MSG_IMPLICIT_COERCION_ERROR, MSG_TYPE_MISMATCH
    var eq4 = 42 - !2               //## issuekeys: MSG_TYPE_MISMATCH, MSG_TYPE_MISMATCH
    var eq5 = 42.5 == ~2
    var eq6 = 42.5 / ~2
    var eq7 = !42 && "hello"        //## issuekeys: MSG_TYPE_MISMATCH
