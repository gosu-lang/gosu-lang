...
class Errant_GosuTestClass2 {
  ...
  class ClassA1 implements JavaInterface2 {
    function test() {
      ...
      var x1b : List = foo({'c', 2b, 3 as short})
      ...
      var x2c : List = super[JavaInterface2].foo({'c', 2b, 3 as short})
      var x3 : List = foo(new ArrayList<Object>())      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.JAVAINTERFACE2' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST)'
      var x4 : List = super[JavaInterface2].foo(new ArrayList<Object>())      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.JAVAINTERFACE2' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST)'
  ...
  class ClassA2 implements JavaInterface2 {
    ...
    function test() {
      ...
      var x1c : List = foo({'c', 2b, 3 as short})
      var x2 : List = super[JavaInterface2].foo(new ArrayList<Integer>())
      var x2a : List = super[JavaInterface2].foo({1, 2, 3})
      var x2b : List = super[JavaInterface2].foo({1, 2, "xyz"})      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.JAVAINTERFACE2' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<? EXTENDS JAVA.LANG.COMPARABLE<?>>>>)'
      var x2c : List = super[JavaInterface2].foo({'c', 2b, 3 as short})
      var x3 : List = foo(new ArrayList<Object>())      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.ERRANT_GOSUTESTCLASS2.CLASSA2' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST)'
      var x4 : List = super[JavaInterface2].foo(new ArrayList<Object>())      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.JAVAINTERFACE2' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST)'
  ...
  class ClassA4 implements JavaInterface2 {
    ...
    function test() {
      ...
      var x2b : List = super[JavaInterface2].foo({1, 2, "xyz"})      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.JAVAINTERFACE2' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<? EXTENDS JAVA.LANG.COMPARABLE<?>>>>)'
      var x2c : List = super[JavaInterface2].foo({'c', 2b, 3 as short})
      var x3 : List = foo(new ArrayList<Object>())      //## issuekeys: CANNOT RESOLVE METHOD 'FOO(JAVA.UTIL.ARRAYLIST)'
      var x4 : List = super[JavaInterface2].foo(new ArrayList<Object>())      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.JAVAINTERFACE2' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST)'
  ...
  class TestClassA1 implements GosuInterface2a {
    function test () {
      ...
      var x2c : List = super[GosuInterface2a].foo({'c', 2b, 3 as short})
      var x3 : List = foo(new ArrayList<Object>())      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.JAVAINTERFACE2' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST)'
      var x4 : List = super[GosuInterface2a].foo(new ArrayList<Object>())      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.JAVAINTERFACE2' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST)'
      var x5 : List = foo(new ArrayList<String>())      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.JAVAINTERFACE2' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST<JAVA.LANG.STRING>)'
  ...
  class TestClassA2 implements GosuInterface2b {
    function test () {
      ...
      var x2b : List = super[GosuInterface2b].foo({1, 2, "xyz"})      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.ERRANT_GOSUTESTCLASS2.GOSUINTERFACE2B' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<JAVA.IO.SERIALIZABLE & JAVA.LANG.COMPARABLE<? EXTENDS JAVA.LANG.COMPARABLE<?>>>>)'
      var x2c : List = super[GosuInterface2b].foo({'c', 2b, 3 as short})
      var x3 : List = foo(new ArrayList<Object>())      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.ERRANT_GOSUTESTCLASS2.GOSUINTERFACE2B' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST)'
      var x4 : List = super[GosuInterface2b].foo(new ArrayList<Object>())      //## issuekeys: 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.DEFAULTMETHODS.JAVAINTERACTION.TOBEPUSHED.ERRANT_GOSUTESTCLASS2.GOSUINTERFACE2B' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST)'
...
//    function foo(s:String) {}
    function test () {
      ...
      var x2c : List = super[GosuInterface2c].foo({'c', 2b, 3 as short})
      var x3 : List = foo(new ArrayList<Object>())      //## issuekeys: CANNOT RESOLVE METHOD 'FOO(JAVA.UTIL.ARRAYLIST)'
      var x4 : List = super[GosuInterface2c].foo(new ArrayList<Object>())      //## issuekeys: CANNOT RESOLVE METHOD 'FOO(JAVA.UTIL.ARRAYLIST)'
      var x5 : List = foo(new ArrayList<String>())      //## issuekeys: CANNOT RESOLVE METHOD 'FOO(JAVA.UTIL.ARRAYLIST<JAVA.LANG.STRING>)'
