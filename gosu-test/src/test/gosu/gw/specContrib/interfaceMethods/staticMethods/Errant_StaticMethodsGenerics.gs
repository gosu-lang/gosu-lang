...
class Errant_StaticMethodsGenerics {
  ...
  class MyClass implements IA {
    function test() {
      ...
      IA.foo2(new ArrayList())      //## issuekeys: 'FOO2(JAVA.UTIL.ARRAYLIST<JAVA.LANG.INTEGER>)' IN 'GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.JAVA8.STATICMETHODS.ERRANT_STATICMETHODSGENERICS.IA' CANNOT BE APPLIED TO '(JAVA.UTIL.ARRAYLIST)'
      ...
      IA.foo3(new ArrayList())      //## issuekeys: INFERRED TYPE 'JAVA.LANG.OBJECT' FOR TYPE PARAMETER 'T' IS NOT WITHIN ITS BOUND; SHOULD EXTEND 'JAVA.LANG.NUMBER'
