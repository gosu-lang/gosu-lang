...
class Errant_FLStaticVsNonStaticMethods {
  ...
  var nnn11 :gw.lang.reflect.features.MethodReference<Errant_FLStaticVsNonStaticMethods, block(x:Errant_FLStaticVsNonStaticMethods)> = #nonstaticfun()

  var nnn12 :gw.lang.reflect.features.BoundMethodReference<Errant_FLStaticVsNonStaticMethods, block()> = this#nonstaticfun()

  static var nnn2 : gw.lang.reflect.features.MethodReference<Errant_FLStaticVsNonStaticMethods, block(x:Errant_FLStaticVsNonStaticMethods)> = #nonstaticfun()
