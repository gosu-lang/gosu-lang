...
class Errant_FLParameterizedFunction {
  ...
  function invokeFun() {
    //1st Set
    //OS Gosu shows error in pFunFLInvoke1111, pFunFLInvoke1113 because of IDE-1587
    var pFunFLInvoke1111 = pFunFL111.invoke("sdf")
    var pFunFLInvoke1112 = pFunFL111.invoke()      //## issuekeys: 'INVOKE(JAVA.LANG.OBJECT)' IN '' CANNOT BE APPLIED TO '()'
    var pFunFLInvoke1113 = pFunFL111.invoke(new Object())
    //check return type
    //IDE-1587 - OS Gosu issue
    var pFunFLInvoke1114 : Object = pFunFL111.invoke("sdf")

    var pFunFLInvoke1121 = pFunFL112.invoke("sdf")      //## issuekeys: 'INVOKE()' IN '' CANNOT BE APPLIED TO '(JAVA.LANG.STRING)'
    //IDE-1587 - OS Gosu issue
    var pFunFLInvoke1122 = pFunFL112.invoke()
    var pFunFLInvoke1123 = pFunFL112.invoke(new Object())      //## issuekeys: 'INVOKE()' IN '' CANNOT BE APPLIED TO '(JAVA.LANG.OBJECT)'
    //Check return type
    //IDE-1587 - OS Gosu issue
    var pFunFLInvoke1124 : String = pFunFL112.invoke()

    var pFunFLInvoke1131 = pFunFL113.invoke("sdf")
    var pFunFLInvoke1132 = pFunFL113.invoke()      //## issuekeys: 'INVOKE(JAVA.LANG.STRING)' IN '' CANNOT BE APPLIED TO '()'
    var pFunFLInvoke1133 = pFunFL113.invoke(new Object())      //## issuekeys: 'INVOKE(JAVA.LANG.STRING)' IN '' CANNOT BE APPLIED TO '(JAVA.LANG.OBJECT)'
    //Check return type
    var pFunFLInvoke1134 : String = pFunFL113.invoke("sdf")
    ...
    //3rd Set
    //IDE-1599 OS Gosu issue for unbounded parameters in a generic function FL
    var pFunFLInvoke3111 = pFunFL111.invoke("sdf")
    var pFunFLInvoke3112 = pFunFL111.invoke()      //## issuekeys: 'INVOKE(JAVA.LANG.OBJECT)' IN '' CANNOT BE APPLIED TO '()'
    //IDE-1599 OS Gosu issue for unbounded parameters in a generic function FL
    var pFunFLInvoke3113 = pFunFL111.invoke(new Object())

    var pFunFLInvoke3121 = pFunFL112.invoke("sdf")      //## issuekeys: 'INVOKE()' IN '' CANNOT BE APPLIED TO '(JAVA.LANG.STRING)'
    //IDE-1587 - OS Gosu issue
    var pFunFLInvoke3122 = pFunFL112.invoke()
    var pFunFLInvoke3123 = pFunFL112.invoke(new Object())      //## issuekeys: 'INVOKE()' IN '' CANNOT BE APPLIED TO '(JAVA.LANG.OBJECT)'

    //OS Gosu - IDE-1599 will impact this once IDE-1588 is fixed
    var pFunFLInvoke3131 = pFunFL113.invoke("sdf")
    var pFunFLInvoke3132 = pFunFL113.invoke()      //## issuekeys: 'INVOKE(JAVA.LANG.STRING)' IN '' CANNOT BE APPLIED TO '()'
    var pFunFLInvoke3133 = pFunFL113.invoke(new Object())      //## issuekeys: 'INVOKE(JAVA.LANG.STRING)' IN '' CANNOT BE APPLIED TO '(JAVA.LANG.OBJECT)'
  }
}