...
class Addition_ErrantCasesTest extends ArithmeticTestBase {
  ...
  function testAdditionBetweenNullAndNull() {
    testErrantType( Addition_ErrantCases.AdditionBetweenNullAndNull, Res.MSG_TYPE_MISMATCH, 1, 0)
  }

  function testAdditionBetweenIntAndBoolean() {
    testErrantType( Addition_ErrantCases.AdditionBetweenIntAndBoolean, Res.MSG_TYPE_MISMATCH, 1, 0)
  }
  
  function testAdditionBetweenTwoBooleans() {
    testErrantType( Addition_ErrantCases.AdditionBetweenTwoBooleans, Res.MSG_TYPE_MISMATCH, 1, 0)
  }
  
  function testAdditionBetweenIntAndNumber() {
    testErrantType( Addition_ErrantCases.AdditionBetweenIntAndNumber, Res.MSG_TYPE_MISMATCH, 1, 0)
  }
  
  function testAdditionBetweenIntAndTypeVariableExtendingNumber() {
    testErrantType( Addition_ErrantCases.AdditionBetweenIntAndTypeVariableExtendingNumber, Res.MSG_TYPE_MISMATCH, 1, 0)
  }
  
  function testAdditionBetweenIntAndTypeVariableExtendingBigDecimal() {
    testErrantType( Addition_ErrantCases.AdditionBetweenIntAndTypeVariableExtendingBigDecimal, Res.MSG_TYPE_MISMATCH, 1, 0)
  }
  
  function testAdditionBetweenIntAndObject() {
    testErrantType( Addition_ErrantCases.AdditionBetweenIntAndObject, Res.MSG_TYPE_MISMATCH, 1, 0)
  }
  
  function testAdditionBetweenObjectAndObject() {
    testErrantType( Addition_ErrantCases.AdditionBetweenObjectAndObject, Res.MSG_TYPE_MISMATCH, 1, 0)
  }
  ...
  function testDifferentDimensionsWithRHSOverrideOnly() {
    ...
    testErrantType( Addition_ErrantCases.DifferentDimensionsWithRHSOverrideOnly, Res.MSG_TYPE_MISMATCH, 2, 1)
  }
  ...
  function testDifferentDimensions() {
    ...
    testErrantType( Addition_ErrantCases.DifferentDimensions, Res.MSG_TYPE_MISMATCH, 2, 1)
  }
  ...
  function testOverrideOnDimensionWithDoubleDoesntApplyToPDouble() {
    ...
    testErrantType( Addition_ErrantCases.OverrideOnDimensionWithDoubleDoesntApplyToPDouble, Res.MSG_TYPE_MISMATCH, 2, 1)
  }
  ...
  function testOverrideOnDimensionWithDoubleDoesntApplyToPFloat() {
    ...
    testErrantType( Addition_ErrantCases.OverrideOnDimensionWithDoubleDoesntApplyToPFloat, Res.MSG_TYPE_MISMATCH, 2, 1)
  }
  ...
  function testOverrideOnDimensionWithPIntDoesntApplyToInteger() {
    ...
    testErrantType( Addition_ErrantCases.OverrideOnDimensionWithPIntDoesntApplyToInteger, Res.MSG_TYPE_MISMATCH, 2, 1)
  }
  ...
  function testOverrideOnDimensionWithPIntDoesntApplyToPShort() {
    ...
    testErrantType( Addition_ErrantCases.OverrideOnDimensionWithPIntDoesntApplyToPShort, Res.MSG_TYPE_MISMATCH, 2, 1)
  } 
