 ...
 */
public class JavaClassDeclSubclassInnerClassUsageContext implements UsageContext {

  private TestGenerationContext _testGenContext;
  public JavaClassDeclSubclassInnerClassUsageContext(TestGenerationContext testGenContext) {
  ...
  public String getTargetClassName() {
    return _testGenContext.constants().javaClassSubclass() + "." + _testGenContext.constants().javaClassSubclassInnerClass();
  }

  @Override
  public ClassFileGenerator getTargetClassFileGenerator(CodeGenerationContext codeGenContext, Member member) {
    ClassFileGenerator cfg = codeGenContext.getClassFileGenerator(_testGenContext.constants().javaClassSubclass()).getOrCreateInnerClass(_testGenContext.constants().javaClassSubclassInnerClass());
    return cfg;
  }
