 ...
 */
public class JavaClassDeclSubclassUsageContext implements UsageContext {

  private TestGenerationContext _testGenContext;
  public JavaClassDeclSubclassUsageContext(TestGenerationContext testGenContext) {
  ...
  public String getTargetClassName() {
    return _testGenContext.constants().javaClassSubclass();
  }
