 ...
 */
public class JavaBackedGosuTypeUnrelatedClassUsageContext implements UsageContext {

  private TestGenerationContext _testGenContext;
  public JavaBackedGosuTypeUnrelatedClassUsageContext(TestGenerationContext testGenContext) {
    _testGenContext = testGenContext;
  }

  @Override
  public String testClassSuffix() {
    return "JavaBackedGosuTypeUnrelatedClass";
  }
