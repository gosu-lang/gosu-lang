 ...
 */
abstract class CorePropertyEvaluationMethod extends EvaluationMethod {

  protected EvaluationRoot _evalRoot;

  protected CorePropertyEvaluationMethod(String suffix, TestMethodStyle testMethodStyle, EvaluationRoot evalRoot) {
