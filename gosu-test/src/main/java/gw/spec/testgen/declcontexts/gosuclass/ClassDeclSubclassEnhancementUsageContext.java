 ...
 */
public class ClassDeclSubclassEnhancementUsageContext implements UsageContext {

  private TestGenerationContext _testGenContext;
  public ClassDeclSubclassEnhancementUsageContext(TestGenerationContext testGenContext) {
