...
public abstract class GosuIntroduceFieldCentralPanel {
  ...
  public GosuIntroduceFieldCentralPanel(PsiClass parentClass,
  ...
  public abstract GosuBaseExpressionToFieldHandler.InitializationPlace getInitializerPlace();
