...
public class ChangeSignatureProcessor extends ChangeSignatureProcessorBase {
  ...
  private static JavaChangeInfo generateChangeInfo(PsiMethod method,
    ...
    return new GosuChangeInfoImpl(newVisibility, method, newName, newType, parameterInfo, thrownExceptions, generateDelegate,
  ...
  @Override
  public GosuChangeInfoImpl getChangeInfo() {
    return (GosuChangeInfoImpl)super.getChangeInfo();
  }
  ...
  protected boolean preprocessUsages(final Ref<UsageInfo[]> refUsages) {
    return ApplicationManager.getApplication().runWriteAction(new Computable<Boolean>() {
      ...
      public Boolean compute() {
        return preprocessUsagesImpl(refUsages);
      }
    });
  }

  protected boolean preprocessUsagesImpl(Ref<UsageInfo[]> refUsages) {
  ...
  public static PsiCallExpression addDelegatingCallTemplate(final PsiMethod delegate, final String newName) throws IncorrectOperationException {
    ...
    if (delegate.isConstructor()) {
      ...
      PsiType returnType = delegate.getReturnType();
