...
/***************************************************************************/
public class Group extends gw.internal.schema.gw.xsd.w3c.xmlschema.types.complex.Annotated implements gw.internal.xml.IXmlGeneratedClass {
  ...
  public static final gw.util.concurrent.LockingLazyVar<gw.lang.reflect.IType> TYPE = new gw.util.concurrent.LockingLazyVar<gw.lang.reflect.IType>( gw.lang.reflect.TypeSystem.getGlobalLock() ) {
          ...
          protected gw.lang.reflect.IType init() {
            return gw.lang.reflect.TypeSystem.getByFullName( "gw.xsd.w3c.xmlschema.types.complex.Group" );
          }
        };
  ...
  protected Group( gw.lang.reflect.IType type, java.lang.Object schemaInfo ) {
  ...
  public java.util.List<gw.internal.schema.gw.xsd.w3c.xmlschema.All> All() {
    ...
    return (java.util.List<gw.internal.schema.gw.xsd.w3c.xmlschema.All>) TYPE.get().getTypeInfo().getProperty( "All" ).getAccessor().getValue( this );
  }
  ...
  public java.util.List<gw.internal.schema.gw.xsd.w3c.xmlschema.anonymous.elements.Group_Element> Element() {
    //noinspection unchecked
    return (java.util.List<gw.internal.schema.gw.xsd.w3c.xmlschema.anonymous.elements.Group_Element>) TYPE.get().getTypeInfo().getProperty( "Element" ).getAccessor().getValue( this );
  }
  ...
  public java.util.List<gw.internal.schema.gw.xsd.w3c.xmlschema.anonymous.elements.Group_Group> Group() {
    //noinspection unchecked
    return (java.util.List<gw.internal.schema.gw.xsd.w3c.xmlschema.anonymous.elements.Group_Group>) TYPE.get().getTypeInfo().getProperty( "Group" ).getAccessor().getValue( this );
  }
