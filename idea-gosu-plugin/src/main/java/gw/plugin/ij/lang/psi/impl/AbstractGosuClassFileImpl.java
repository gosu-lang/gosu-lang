      ...
      if (!isForCompletion) {
        ...
        try {
          ...
          if (type != null) {
            ...
            GosuClassParseInfo parseInfo = ((IGosuClassInternal)gsClass).getParseInfo();
            if (forceRefresh || (parseInfo != null && contentsFingerPrint != parseInfo.getSourceFingerprint())) {
              refreshFile(gsClass);
            }
            ...
            if (parseInfo != null && contentsFingerPrint == parseInfo.getSourceFingerprint()) {
