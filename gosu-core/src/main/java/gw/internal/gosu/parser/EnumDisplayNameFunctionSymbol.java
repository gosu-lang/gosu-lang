...
/**
 */
public class EnumDisplayNameFunctionSymbol extends DynamicFunctionSymbol
{
  public EnumDisplayNameFunctionSymbol( IGosuClassInternal gsClass, ISymbolTable symTable )
  {
    super( symTable, "@DisplayName",
           new FunctionType( "@DisplayName", JavaTypes.STRING(), null ),
