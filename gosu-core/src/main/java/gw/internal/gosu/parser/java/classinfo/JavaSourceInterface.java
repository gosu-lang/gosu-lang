...
public class JavaSourceInterface extends JavaSourceType {
   ...
   * For top level.
   */
  public JavaSourceInterface( ISourceFileHandle fileHandle, CompilationUnitTree compilationUnitTree, ClassTree typeDecl, List<? extends ImportTree> imports, SourcePositions sourcePositions, IModule gosuModule ) {
