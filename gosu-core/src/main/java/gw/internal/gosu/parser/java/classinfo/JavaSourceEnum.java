...
public class JavaSourceEnum extends JavaSourceType {
   ...
   * For top level.
   */
  public JavaSourceEnum( ISourceFileHandle fileHandle, CompilationUnitTree compilationUnitTree, ClassTree typeDecl, List<? extends ImportTree> imports, SourcePositions sourcePositions ) {
