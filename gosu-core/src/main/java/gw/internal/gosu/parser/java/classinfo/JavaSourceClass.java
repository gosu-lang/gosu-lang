...
public class JavaSourceClass extends JavaSourceType {
   ...
   */
  public JavaSourceClass( ISourceFileHandle fileHandle, CompilationUnitTree compilationUnitTree, ClassTree typeDecl, List<? extends ImportTree> imports, SourcePositions sourcePositions, IModule gosuModule ) {
